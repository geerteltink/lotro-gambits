GambitLayout = {{
    ...
    Enabled = true,
    Placement = "right",
    Gambits = {1091471252, -- Exultation of Battle
    1091471244, -- Spear of Virtue
    1091471251, -- Brink of Victory
    ...
    Enabled = true,
    Placement = "left",
    Gambits = {1091469970, -- Defensive Strike
    1091471248, -- Shield Mastery
    ...
    Enabled = true,
    Placement = "right",
    Gambits = {1091471255, -- Fierce Resolve
    ...
    Enabled = true,
    Placement = "right",
    Gambits = {1091469969, -- Deft Strike
